...
public class PlaylistController {
    ...
    public ResponseEntity<ResponseDto> generatePlaylist(@PathVariable Long moodId) {
        try {
            ...
            // FIXED: Call generatePlaylist, NOT getUserPlayLists
            PlaylistResponseDto playlist = playlistService.generatePlaylist(username, moodId);

            responseDto.setCode(VarList.RSP_SUCCESS);
            responseDto.setMessage("Playlist generated successfully");
            responseDto.setContent(playlist);
    ...
    public ResponseEntity<ResponseDto> getUserPlaylists() {
        try {
            ...
            responseDto.setContent(playlists);
            return new ResponseEntity<>(responseDto, HttpStatus.OK);
        } catch (Exception e) {
            responseDto.setCode(VarList.RSP_ERROR);
            responseDto.setMessage(e.getMessage());
